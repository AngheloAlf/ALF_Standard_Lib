...
# 1 "src/ALF_std.h" 1
# 11 "src/ALF_std.h"
# 1 "src/ALF_std/ALF_version.h" 1



# 1 "src/ALF_std/ALF_common.h" 1
# 5 "src/ALF_std/ALF_version.h" 2
# 12 "src/ALF_std.h" 2

# 1 "src/ALF_std/ALF_bit.h" 1
# 14 "src/ALF_std.h" 2
# 1 "src/ALF_std/ALF_bytes.h" 1
# 10 "src/ALF_std/ALF_bytes.h"
typedef struct{
    char *bytes;
    long size;
} ALF_bytes;
# 24 "src/ALF_std/ALF_bytes.h"
...
# 15 "src/ALF_std.h" 2
# 1 "src/ALF_std/ALF_bool.h" 1
# 14 "src/ALF_std/ALF_bool.h"
    typedef enum{
        false,
        true,
    } bool;
# 16 "src/ALF_std.h" 2
# 1 "src/ALF_std/ALF_IO.h" 1
# 37 "src/ALF_std/ALF_IO.h"
char *ALF_IO_raw_input(const char *outMessage);
# 54 "src/ALF_std/ALF_IO.h"
void ALF_IO_puthex(unsigned char character);
# 74 "src/ALF_std/ALF_IO.h"
void ALF_IO_printfColoredBlock(unsigned char character, char withNumber);
# 17 "src/ALF_std.h" 2
# 1 "src/ALF_std/ALF_jit.h" 1
# 10 "src/ALF_std/ALF_jit.h"
...
# 37 "/usr/include/x86_64-linux-gnu/sys/mman.h" 3 4
...
# 17 "src/ALF_std/ALF_jit.h" 2



# 19 "src/ALF_std/ALF_jit.h"
typedef struct {
    uint64_t position;
...
# 18 "src/ALF_std.h" 2
# 1 "src/ALF_std/ALF_math.h" 1
# 13 "src/ALF_std/ALF_math.h"
char ALF_MATH_multiply(uint64_t a, uint64_t b, uint64_t *result, uint64_t *carry);
# 19 "src/ALF_std.h" 2
# 1 "src/ALF_std/ALF_OS.h" 1
# 20 "src/ALF_std/ALF_OS.h"
...
# 71 "src/ALF_std/ALF_OS.h"
char ALF_OS_isOther(void);
# 20 "src/ALF_std.h" 2
# 1 "src/ALF_std/ALF_str.h" 1
# 10 "src/ALF_std/ALF_str.h"
...
# 11 "src/ALF_std/ALF_str.h" 2
# 25 "src/ALF_std/ALF_str.h"
...
# 3 "tests/printf_version.c" 2


# 4 "tests/printf_version.c"
int main(){
 printf("ALF_std_major_version: %d\n", 1);
 printf("ALF_std_minor_version: %d\n", 1);
 printf("ALF_std_patch_version: %d\n", 1);
 printf("ALF_std_version: %f\n", 1.1);
 printf("ALF_std_version_str: %s\n", "1" "." "1" "." "1");
